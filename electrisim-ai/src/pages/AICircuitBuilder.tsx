...
import { ArrowLeft, Home, Zap, Loader, CheckCircle, AlertTriangle, Info, PanelRight, X, MessageCircle } from 'lucide-react';
  ...
  const generateAISummary = async () => {
    ...
    try {
      const summary = `
        ...
        • Compliance: Meets NEC, OSHA, and NFPA standards
